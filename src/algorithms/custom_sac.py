"""
Custom SAC extending RLLib's SAC with fixes shared across all custom algorithms:
...
class CustomSAC(SAC):
    ...
    def load_checkpoint(self, checkpoint_dir: str) -> None:
        # BugFix: when only a subset of policies are checkpointed, pass policy_ids
        # explicitly so _checkpoint_info_to_algorithm_state does not try to restore
        # policies that were never saved.
