...
#
# Usage: bash experiments/slurm/unicluster/cpu_efficiency.sh
...
# ---------------------------------------------------------------------------
BASE_ARGS="training=ppo model=ragnn obs_space=graph relation_awareness=default rollouts.num_gpus_per_learner_worker=0 experiment.seed=0 experiment.nb_timesteps=8000 rollouts.num_rollout_workers=1"
