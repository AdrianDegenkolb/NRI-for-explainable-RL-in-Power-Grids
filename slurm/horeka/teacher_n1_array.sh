...
# N-1 Teacher action-space generation — SLURM array sharded one chronic per task.
#
...
#
# IMPORTANT: --time below is a placeholder. Run slurm/horeka/benchmark_teacher_cost.sh first
...
# truncates towards the start of its chronic and biases the resulting action set.
#
# Runs in the separate `curriculum` conda environment (environment_curriculum.yaml) — never L2RPN.
#
# Usage:
#   slurm/horeka/teacher_n1_array.sh <grid> <experiment_name> <max_concurrent> <lines_to_attack...>
#
# Arguments:
#   grid              case36 | case118
...
#
# Example:
#   slurm/horeka/teacher_n1_array.sh case36 2026_09_20_teacher_n1_case36 50 3 12 27 41 58 60 71 88 95 101
